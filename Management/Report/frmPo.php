    ...
    <div class="container font12b">
        ...
        <div class="table-responsive">
            <table class="table table-striped" style="width: 1300px;">
                ...
                <?php
                    $sqlsearch = "select d.po_id,p.po_id as po2,p.po_date,d.bill,d.pdet_name,d.qty,d.price,d.qty*d.price as total,note,rate_id,p.status,emp_name from podetail d left join po p on p.po_id=d.po_id left join employees e on p.emp_id=e.emp_id where p.po_date between '$date1' and '$date2' or d.rate_id='$rate_id';";
                ...
                <?php
                    ...
                    $sqlsum = "select sum(d.qty*d.price) as amount_kip,rate_id from podetail d left join po p on d.po_id=p.po_id where p.po_date between '$date1' and '$date2' and rate_id='LAK';";
                    $resultsum = mysqli_query($link,$sqlsum);
                    $rowsum = mysqli_fetch_array($resultsum, MYSQLI_ASSOC);
                    $sqlsum2 = "select sum(d.qty*d.price) as amount_baht,rate_id from podetail d left join po p on d.po_id=p.po_id where p.po_date between '$date1' and '$date2' and rate_id='THB';";
                    $resultsum2 = mysqli_query($link,$sqlsum2);
                    $rowsum2 = mysqli_fetch_array($resultsum2, MYSQLI_ASSOC);
                    $sqlsum3 = "select sum(d.qty*d.price) as amount_us,rate_id from podetail d left join po p on d.po_id=p.po_id where p.po_date between '$date1' and '$date2' and rate_id='USD';";
    ...
    <div class="container font12b">
        ...
        <div class="table-responsive">
            <table class="table table-striped" style="width: 1300px;">
                ...
                <?php
                    $sqlsearch = "select d.po_id,p.po_id as po2,p.po_date,d.bill,d.pdet_name,d.qty,d.price,d.qty*d.price as total,note,rate_id,p.status,emp_name from podetail d left join po p on p.po_id=d.po_id left join employees e on p.emp_id=e.emp_id;";
                    $resultsearch = mysqli_query($link,$sqlsearch);
                    $No_ = 0;
                    while($row = mysqli_fetch_array($resultsearch, MYSQLI_ASSOC)){
                ?>
