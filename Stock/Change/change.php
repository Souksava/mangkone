     ...
     <div class="container" >
        <div style="float: left;width: 260px;">
           <a href="#" data-toggle="modal" data-target="#myModal1">
                <img src="../Management/images/<?php echo $_SESSION['img_path']; ?>" width="200px" height="200px" alt="" class="img-circle imagelist"  />
           </a>
            <div class="modal fade" id="myModal1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                <div class="modal-dialog" role="document">
                    <img src="../Management/images/<?php echo $_SESSION['img_path']; ?>" width="100%"  class="img-circle imagelist" />
                </div>
            </div>
