...
<html>
  ...
  <body >
    ...
    <?php
        ...
        $sqlget = "select quo_id,upper(emp_name) as emp_name,upper(emp_surname) as emp_surname,e.email as emp_email,kip_amount,us_amount,baht_amount,in_date,in_time,company,c.email as cus_email,c.tel as cus_tel,e.tel as emp_tel,c.address,i.img_path from quotation i left join employees e on i.emp_id=e.emp_id left join customers c on i.cus_id=c.cus_id where i.quo_id = '$quo_id';";
    ...
    ?>
    <form action="Report_quotation_in_dis.php" method="POST" id="form1">
        <div class="container font14">
            <div class="row">
                <div style="float: left;">
                    <label>ເລກທີ invoice: <?php echo $rowget['quo_id'];?></label><br>
            ...
            <div class="row">
                <div class="col-xs-12 col col-sm-6 col-md-4 form-group">
                <?php
                ...
                ?>
                    <div class="input-group-prepend">
                        <div class="input-group-text">
                            <input type="checkbox" name="package[]" value="<?php echo $rowaccppy[1]?>"> <?php echo $rowaccppy[1]?>
                        </div>
                    </div>
                </div>
                <?php 
    ...
    <div class="container font14">
        <table class="table table-striped">
            ...
            <?php
               $sql = "select quodet_id,i.pro_id,pro_name,i.qty,i.price,i.qty*i.price as total,i.note,rate_id from quotationdetail i left join acc_product p on i.pro_id=p.pro_id where quo_id='$quo_id';";
            ...
            <?php
               ...
               $sqlsum = "select sum((qty*price) + vat) as newamount,rate_id,sum(qty*price) as amount,sum(vat) as vat,kip_amount,baht_amount,us_amount from quotationdetail d left join quotation i on d.quo_id=i.quo_id where d.quo_id = '$quo_id' group by rate_id;";
            ...
            ?>
             <tr class="font26 danger">
                ...
                <td colspan="3" align="right"> <?php echo $rowsum['rate_id'];?> <?php echo number_format($rowsum['amount'],2);?></td>
            </tr>
            <tr class="font26 danger">
                <td colspan="3" align="right"><b>VAT:</b></td>
                <td colspan="3" align="right"><?php echo $rowsum['rate_id'];?> <?php echo number_format($rowsum['vat'],2);?> </td>
            </tr>
            <tr class="font26 danger">
                <td colspan="3" align="right"><b>ຍອດລວມ:</b></td>
                <td colspan="3" align="right"><?php echo $rowsum['rate_id'];?> <?php echo number_format($rowsum['newamount'],2);?> </td>
            </tr>
            <tr class="font26 danger">
                <td colspan="3" align="right"><b>ສ່ວນລົດ:</b></td>
                <td colspan="3" align="right"> (<?php echo $rowsum['rate_id'];?> <?php echo number_format($discount,2);?>)</td>
            </tr>
            <tr class="font26 danger">
                <td colspan="3" align="right"><b>Total Amount:</b></td>
                <td colspan="3" align="right"><?php echo $rowsum['rate_id'];?> <?php echo number_format($rowsum['newamount'] - $discount,2);?></td>
            </tr>
        </table>
    </div>
