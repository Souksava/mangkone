...
<html>
  <head>
    ...
    <title>Quotation Rate LAK</title>
  ...
  <body >
    ...
    <div class="container font16">
        <form action="quotation_in_kip.php" method="POST" id="form1" enctype="multipart/form-data">
            <div class="row ">
    ...
    <?php
        if(isset($_POST['btnadd'])){
            ...
            if(trim($pro_id) == ""){
                ...
                echo"window.location.href='quotation_in_kip.php';";
                echo"</script>";
            }
            elseif(trim($qty) == ""){
                echo"<script>";
            ...
            elseif(trim($price) == ""){
                ...
                $sqlck = "select * from listquotationdetail where rate_id = 'THB' or rate_id = 'USD';";
               ...
               elseif(mysqli_num_rows($resultqty) > 0){
                    ...
                    $vat = ($price * $qty) * 0.10;
                    $sqladd = "insert into listquotationdetail(pro_id,qty,price,vat,quo_id,rate_id,note,acc_id) values('$pro_id','$qty','$price','$vat','$quo_id','LAK','$note','714100');";
    ...
    <div class="container font14">
        <hr width="90%" />
        <form action="quotation_in_kip.php" method="POST" id="formsave">
            <div class="row">
            ...
            <div class="table-responsive">
                <table class="table table-striped">
                    ...
                    <tr>
                    <?php
                        $sqlshow = "select quodet_id,pro_name,qty,l.price,qty*l.price as total,note from listquotationdetail l left join acc_product p on l.pro_id=p.pro_id where rate_id='LAK';";
                    ...
                    ?>
                        ...
                        <td>
                            <a href="delete_in_kip.php?quodet_id=<?php echo $rowshow['quodet_id'];?>">
                    ...
                    <?php
                        ...
                        $sqlamount = "select sum(qty*price) as amount from listquotationdetail where rate_id='LAK';";
                    ...
                    <tr class="danger">
                        ...
                        <th colspan="3" style="text-align: center;font-size: 18px;"><b><?php echo number_format($rowamount['amount'],2); ?> ກີບ</b>
                    ...
                    <tr class="danger">
                        ...
                        <th colspan="3" style="text-align: center;font-size: 18px;"><b><?php echo number_format($showvat,2); ?> ກີບ</b>
                    ...
                    <tr class="danger">
                        ...
                        <th colspan="4" style="text-align: right;font-size: 18px;"><b>Amount</b></th>
                        <th colspan="3" style="text-align: center;font-size: 18px;"><b><?php echo number_format($newamount,2); ?> ກີບ</b>
    ...
    <?php
        if(isset($_POST['btnSave'])){
           ...
           elseif($amount == 0){
                ...
                $sqlsave = "insert into quotation(quo_id,emp_id,kip_amount,in_date,in_time,cus_id) values('$quo_id2','$emp_id','$amount','$Date','$Time','$cus_id');";
