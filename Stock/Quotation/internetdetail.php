...
<html>
  ...
  <body >
    ...
    ?>
    <form action="Report_quotation_in.php" method="POST" id="form1">
    ...
    <div class="container font14">
        <table class="table table-striped" style="width: 1200px;">
            ...
            <?php
               $sql = "select quodet_id,i.pro_id,pro_name,i.qty,i.price,i.qty*i.price as total,i.note,rate_id from quotationdetail i left join acc_product p on i.pro_id=p.pro_id where i.quo_id='$quo_id';";
            ...
            <?php
               ...
               $sqlsum = "select sum((qty*price) + vat) as newamount,rate_id,sum(qty*price) as amount,sum(vat) as vat from quotationdetail where quo_id = '$quo_id' group by rate_id;";
