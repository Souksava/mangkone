    ...
    <div class="container font16">
        <div class="row ">
            <div class="col-xs-12 col-sm-6 col-md-4" align="center">
                <a href="quo_internet.php" class="font16">
                     <img src="../../image/invoice.png" width="155px" class="img-responsive" ><br>
                     <b>Quotation <br>(INTERNET)</b>
                </a>
            </div>
            <div class="col-xs-12 col-sm-6 col-md-4" align="center">
                <a href="quo_product.php" class="font16">
                     <img src="../../image/invoice.png" width="155px" class="img-responsive" ><br>
                     <b>Quotation <br>(Product)</b>
                </a>
            </div>
            <div class="col-xs-12 col-sm-6 col-md-4" align="center">
                <a href="faem_quotation.php" class="font16">
