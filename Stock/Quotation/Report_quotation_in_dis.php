...
function ShowData(){
    ...
    $sqlsum = "select sum((qty*price) + vat) as newamount,rate_id,sum(qty*price) as amount,sum(vat) as vat,kip_amount,baht_amount,us_amount from quotationdetail d left join quotation i on d.quo_id=i.quo_id where d.quo_id = '$quo_id2' group by rate_id;";
...
$mpdf->Output('ໃບສະເໜີລາຄາອິນເຕີເນັດແບບມີສ່ວນລົດ.pdf','I');
?>