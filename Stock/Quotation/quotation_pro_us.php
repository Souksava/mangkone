...
<html>
  ...
  <body >
    ...
    <div class="container font16">
        <form action="quotation_pro_us.php" method="POST" id="form1" enctype="multipart/form-data">
            <div class="row ">
    ...
    <div class="container font14">
        <hr width="90%" />
        <form action="quotation_pro_us.php" method="POST" id="formsave">
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-4 form-group" >
            ...
            <div class="table-responsive">
                <table class="table table-striped">
                    ...
                    <tr>
                    <?php
                        $sqlshow = "select quodet_id,l.pro_id,pro_name,qty,l.price,qty*l.price as total,note from listquotationdetail2 l left join products p on l.pro_id=p.pro_id where rate_id='USD';";
                    ...
                    ?>
                        ...
                        <td>
                            <a href="delete_pro_us.php?quodet_id=<?php echo $rowshow['quodet_id'];?>">
                    ...
                    <?php
                        ...
                        $sqlamount = "select sum(qty*price) as amount from listquotationdetail2 where rate_id='USD';";
        ...
        if(isset($_POST['btnSave'])){
           ...
           elseif($amount == 0){
            ...
            echo"</script>";
                ...
                $sqlsave = "insert into quotation2(quo_id,emp_id,us_amount,in_date,in_time,cus_id) values('$quo_id2','$emp_id','$amount','$Date','$Time','$cus_id');";
