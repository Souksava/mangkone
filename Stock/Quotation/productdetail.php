...
<html>
  ...
  <body >
    ...
    ?>
    <form action="Report_quotation_pro.php" method="POST" id="form1">
    ...
    <div class="container font14">
        <table class="table table-striped">
            ...
            <?php
               ...
               $sqlsum = "select sum((qty*price) + vat) as newamount,rate_id,sum(qty*price) as amount,sum(vat) as vat from quotationdetail2 where quo_id = '$quo_id' group by rate_id;";
