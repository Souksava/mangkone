...
<html>
  ...
  <body >
    ...
    ?>
    <form action="Report_quotation_pro_dis.php" method="POST" id="form1">
    ...
    <div class="container font14">
        <div class="table-responsive">
            <table class="table table-striped" style="width: 1200px;">
                ...
                <?php
                $sql = "select quodet_id,i.pro_id,pro_name,serial,mac_address,i.qty,i.price,i.qty*i.price as total,i.note,rate_id from quotationdetail2 i join products p on i.pro_id=p.pro_id where quo_id='$quo_id';";
                ...
                $sqlsum = "select sum((qty*price) + vat) as newamount,rate_id,sum(qty*price) as amount,sum(vat) as vat,kip_amount,us_amount,baht_amount from quotationdetail2 d left join quotation2 i on d.quo_id=i.quo_id where d.quo_id = '$quo_id' group by rate_id;";
                ...
                <tr class="font26 danger">
                    ...
                    <td colspan="2" align="right"><?php echo $rowsum['rate_id'];?> <?php echo number_format($rowsum['amount'],2);?> </td>
                </tr>
                <tr class="font26 danger">
                    <td colspan="7" align="right"><b>VAT:</b></td>
                    <td colspan="2" align="right"><?php echo $rowsum['rate_id'];?> <?php echo number_format($rowsum['vat'],2);?> </td>
                </tr>
                <tr class="font26 danger">
                    <td colspan="7" align="right"><b>ຍອດລວມ:</b></td>
                    <td colspan="2" align="right"><?php echo $rowsum['rate_id'];?> <?php echo number_format($rowsum['newamount'],2);?> </td>
                </tr>
                <tr class="font26 danger">
                    <td colspan="7" align="right"><b>ສ່ວນລົດ:</b></td>
                    <td colspan="2" align="right">(<?php echo $rowsum['rate_id'];?> <?php echo number_format($discount,2);?>)</td>
                </tr>
                <tr class="font26 danger">
                    <td colspan="7" align="right"><b>ຍອດລວມ:</b></td>
                    <td colspan="2" align="right"><?php echo $rowsum['rate_id'];?> <?php echo number_format($rowsum['newamount'] - $discount,2);?> </td>
                </tr>
            </table>
        </div>
    </div>
