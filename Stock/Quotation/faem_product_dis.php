    ...
    <div class="container font16">
        <div class="row">
            <div class="col-xs-12 col-sm-6">
                <b>ແຟ້ມສະເໜີລາຄາສິນຄ້າປະເພດອຸປະກອນ</b>&nbsp <img src="../../image/hidemenu.png" width="15px">
            </div>
            <div class="col-xs-12 col-sm-6 form-group" align="right">
                <form action="faem_product_dis.php" method="POST" id="fomrsearch">
    ...
    <div class="container font12b">
        <div class="table-responsive">
            <table class="table table-striped" style="width: 1300px;">
                ...
                <?php
                    $search = "%".$_POST['search']."%";
                    $sqlsearch = "select i.quo_id,emp_name,kip_amount,baht_amount,us_amount,in_date,in_time,company,i.img_path from quotation2 i left join employees e on i.emp_id=e.emp_id left join customers c on i.cus_id=c.cus_id  where i.quo_id like '$search' or e.emp_name like '$search' or company like '$search' or in_date like '$search';";
                ...
                <tr>
                    ...
                    <td>
                        <a href="productdetail_dis.php?quo_id=<?php echo $row['quo_id']; ?>">
                ...
                <?php
                    ...
                    $sqlsum = "select count(quo_id) as qty,sum(kip_amount) as totalkip,sum(baht_amount) as totalbaht,sum(us_amount) as totalus from quotation2;";
                ...
                <tr class="danger" style="font-size: 16px;">
                    ...
                    <th colspan="3"  style="text-align: center;">ຍອດລວມບາດ: <?php echo number_format($rowsum['totalbaht'],2); ?> ບາດ</th>
                    <th colspan="4"  style="text-align: center;">ຍອດລວມໂດລາ: <?php echo number_format($rowsum['totalus'],2); ?> ໂດລາ</th>
                </tr>
            </table>
        </div>
    </div>
    <?php
        if(isset($_POST['btnUpload'])){
            ...
            if($_FILES['img_path']['name'] == ""){
                ...
                $sqlsec = "select img_path from quotation2 where quo_id='$quo_id';";
                ...
                $sqlupload = "update quotation2 set img_path='$pro_img' where quo_id='$quo_id';";
