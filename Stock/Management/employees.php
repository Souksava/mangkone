    ...
    <div class="container font12b" >
        <div class="table-responsive">
            <table class="table table-striped" style="width: 2000px;">
                ...
                <?php
                    $search = "%".$_POST['search']."%";
                    $sqlselect = "select emp_id,emp_name,emp_surname,gender,img_path,dob,address,tel,email,pass,auther_name,salary,start_work,end_work,status from employees e join auther a on e.auther_id=a.auther_id where e.emp_id like'$search' or e.emp_name like'$search' or e.emp_surname like'$search' or e.gender like'$search';";
                ...
                <tr>
                    ...
                    <td>
                        <img src="images/<?php echo $row['img_path']; ?>" width="50px" height="50px" alt="" class="img-circle" /><br>
                    </td>
                    <td>
