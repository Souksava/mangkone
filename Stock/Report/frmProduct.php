...
<html>
  ...
  <body >
    <!-- head -->
     ...
     <!-- head -->
      ...
      <div class="container font16">
            <div class="row">
                <div class="col-xs-12 col-sm-6">
                    <b>ລາຍງານສິນຄ້າ</b>&nbsp <img src="../../image/hidemenu.png" width="15px">
                </div>
            </div>
            <br>
      </div> 
      <div class="container font12">
            <div class="row">
                <form action="frmProduct.php" method="POST" id="fomrsearch">
    ...
    <div class="container font12b">
        <div>
            <form action="Report_Product.php" method="POST" id="form1">
        ...
        <div class="table-responsive">
            <table class="table table-striped" style="width: 1300px;">
                ...
                <?php
                    $sqlsearch = "select pro_id,pro_name,unit_name,cate_name,price,price_baht,price_us,img_path from products p left join category c on p.cate_id=c.cate_id left join unit u on p.unit_id=u.unit_id where pro_id='$pro_id' or pro_name='$pro_id' or p.cate_id='$cate_id' or p.unit_id='$unit_id' order by pro_name asc;";
                ...
                <tr>
                    ...
                    <td><?php echo number_format($row['price_baht'],2);?> THB</td>
                    <td><?php echo number_format($row['price_us'],2);?> USD</td>
                    <td>
    ...
    <div class="container font12b">
        ...
        <div class="table-responsive">
            <table class="table table-striped" style="width: 1300px;">
                ...
                <?php
                    $sqlsearch = "select pro_id,pro_name,unit_name,cate_name,price,price_baht,price_us,img_path from products p left join category c on p.cate_id=c.cate_id left join unit u on p.unit_id=u.unit_id;";
                    $resultsearch = mysqli_query($link,$sqlsearch);
                    $No_ = 0;
                    while($row = mysqli_fetch_array($resultsearch, MYSQLI_ASSOC)){
                ?>
