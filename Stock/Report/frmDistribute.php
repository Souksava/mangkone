...
<html>
  <head>
    ...
    <title>ລາຍງານການເບີກຈ່າຍສິນຄ້າ</title>
  ...
  <body >
    <!-- head -->
     ...
     <!-- head -->
      ...
      <div class="container font16">
            <div class="row">
                <div class="col-xs-12 col-sm-6">
                    <b>ລາຍງານການເບີກຈ່າຍສິນຄ້າ</b>&nbsp <img src="../../image/hidemenu.png" width="15px">
                </div>
            </div>
            <br>
      </div> 
      <div class="container font14">
            <div class="row">
                <form action="frmDistribute.php" method="POST" id="fomrsearch">
    ...
    <div class="container font12b">
        <div>
            <form action="Report_distribute.php" method="POST" id="form1">
        ...
        <div class="table-responsive">
            <table class="table table-striped" style="width: 2000px;">
                <tr>
                    ...
                    <th style="width: 60px">ວັນທີເບີກ</th>
                ...
                <?php
                     $sqlsearch = "select datedis,timedis,emp_name,d.pro_id,unit_name,cate_name,pro_name,d.serial,d.mac_address,d.qty,company,note,p.img_path from distribute d left join products p on d.pro_id=p.pro_id left join category c on p.cate_id=c.cate_id left join unit u on p.unit_id=u.unit_id left join customers cs on d.cus_id=cs.cus_id left join employees e on d.emp_id=e.emp_id where datedis between '$date1' and '$date2' or d.emp_id='$emp_id' or d.cus_id='$cus_id';";
                ...
                <tr>
                    ...
                    <td><?php echo $row['datedis']; ?></td>
                    <td><?php echo $row['timedis']; ?></td>
                ...
                <?php
                    ...
                    $sqlkip = "select count(*) as amount from distribute  where datedis between '$date1' and '$date2' or emp_id='$emp_id' or cus_id='$cus_id';";
    ...
    <div class="container font12b">
        ...
        <div class="table-responsive">
            <table class="table table-striped" style="width: 2000px;">
                ...
                <?php
                    $sqlsearch = "select datedis,timedis,emp_name,d.pro_id,unit_name,cate_name,pro_name,d.serial,d.mac_address,d.qty,company,note,p.img_path from distribute d left join products p on d.pro_id=p.pro_id left join category c on p.cate_id=c.cate_id left join unit u on p.unit_id=u.unit_id left join customers cs on d.cus_id=cs.cus_id left join employees e on d.emp_id=e.emp_id;";
                    $resultsearch = mysqli_query($link,$sqlsearch);
                    $No_ = 0;
                    while($row = mysqli_fetch_array($resultsearch, MYSQLI_ASSOC)){
                ?>
                ...
                <?php
                    ...
                    $sqlkip = "select count(*) as amount from distribute";
                    $resultkip = mysqli_query($link,$sqlkip);
                    $rowkip = mysqli_fetch_array($resultkip, MYSQLI_ASSOC);
                ?>
                 <tr class="font26">
