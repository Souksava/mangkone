        ...
        while($row = mysqli_fetch_array($result, MYSQLI_ASSOC)){
            ...
            $output .='
                <tr align="center">
                    ...
                    <td align="center">'.$row["datedis"].'</td>
                    <td align="center">'.$row["timedis"].'</td>
...
$content = '
            ...
            <table width="100%" border="1" cellspacing="0" cellpadding="3" style="font-size: 8px;">
                <tr align="center" style="background-color: #dbdbd8">
                    ...
                    <th style="width: 35px">ວັນທີເບີກ</th>
...
$mpdf->Output('ລາຍງານການເບີກຈ່າຍສິນຄ້າ.pdf','I');
?>