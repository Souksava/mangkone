...
<html>
  ...
  <body >
      ...
      <div class="container font16">
            <div class="row">
                <div class="col-xs-12 col-sm-6">
                    <b>ລາຍງານຜູ້ສະໜອງ</b>&nbsp <img src="../../image/hidemenu.png" width="15px">
                </div>
            </div>
            <br>
      </div> 
    <div class="container font12">
        <div class="row">
            <form action="frmSupplier.php" method="POST" id="fomrsearch">
                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 form-group">
                    <input type="text" class="form-control" name="company" placeholder="ລະຫັດຜູ້ສະໜອງ ຫຼື ຊື່ບໍລິສັດ">
                </div>
                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 form-group">
    ...
    <div class="container font12b">
        <div>
            <form action="Report_supplier.php" method="POST" id="form1">
        ...
        <div class="table-responsive">
            <table class="table table-striped" style="width: 1300px;">
                ...
                <?php
                    $sqlsearch = "select * from supplier where sup_id like '$company' or company like '$company';";
    ...
    <div class="container font12b">
        ...
        <div class="table-responsive">
            <table class="table table-striped" style="width: 1300px;">
                ...
                <?php
                    $sqlsearch = "select * from supplier;";
                    $resultsearch = mysqli_query($link,$sqlsearch);
                    $No_ = 0;
                    while($row = mysqli_fetch_array($resultsearch, MYSQLI_ASSOC)){
                ?>
