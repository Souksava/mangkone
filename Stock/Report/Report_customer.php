...
function ShowData(){
    ...
    if(isset($_POST['btn'])){
        $sql = "select * from customers where cus_id like '$company' or company like '$company';";
        ...
        $sqlAmount = "select count(*) as count from customers where cus_id like '$company' or company like '$company';";
    ...
    if(isset($_POST['btnall'])){
        ...
        $sqlAmount = "select count(*) as count from customers;";
        $result7 = mysqli_query($link, $sqlAmount);
        $rowAmount = mysqli_fetch_array($result7, MYSQLI_ASSOC);
        $output .='
                    <tr class="fontblack18">
