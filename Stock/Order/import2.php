  ...
  <body >
    ...
    <div class="container font16" align="center">
        <form action="import2.php" method="POST" id="form1">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 form-group"> 
                    <input type="text" name="billimp" value="" min="0" id="" class="form-control" placeholder="ເລກທີບິນນຳເຂົ້າ">
                </div>
                <div class="col-xs-12 col-sm-6 form-group">
        ...
        if(isset($_POST['btnAdd'])){
            ...
            elseif(trim($sup_id) == ""){
                ...
                if(mysqli_num_rows($resultserial) > 0){
                    echo"<script>";
                    echo"alert('ໝາຍເລກ Serial ນີ້ຊ້ຳກັນ, ກະລຸນາໃສ່ໝາຍເລກ serial ໃໝ່');";
                    echo"window.location.href='import2.php';";
                    echo"</script>";
                }
                ...
                elseif(mysqli_num_rows($resultmac) > 0){
                    echo"<script>";
                    echo"alert('Mac Address ນີ້ມີຢູ່ແລ້ວກະລຸນາໃສ່ໝາຍເລກ Mac Address ທີ່ແຕກຕ່າງ');";
                    echo"window.location.href='import2.php';";
                    echo"</script>";
                }
                else {
                    $sqlckbaht = "select * from listimp where rate_id='THB';";
                    ...
                    if(mysqli_num_rows($resultbaht) > 0){
                        echo"<script>";
                        echo"alert('ກະລຸນາລໍຖ້າ ເນື່ອງຈາກຕອນນີ້ມີຜູ້ໃຊ້ລະບົບກຳລັງທຳການນຳສິນຄ້າເຂົ້າສາງໃນສະກຸນເງິນບາດຢູ່ໃນຕອນນີ້, ກະລຸນາລໍຖ້າຈົນກວ່າການນຳເຂົ້າສິນຄ້າໃນສະກຸນເງິນບາດຈະເສັດສິ້ນຈຶ່ງສາມາດນຳເຂົ້າສິນຄ້າໃນສະກຸນເງິນກີບໄດ້');";
                        echo"window.location.href='import2.php';";
                        echo"</script>";
                    }
                    elseif(mysqli_num_rows($resultpo) > 0){
                        echo"<script>";
                        echo"alert('ກະລຸນາລໍຖ້າ ເນື່ອງຈາກຕອນນີ້ມີຜູ້ໃຊ້ລະບົບກຳລັງທຳການລົງບັນຊີລາຍຈ່າຍຢູ່ໃນຕອນນີ້, ກະລຸນາລໍຖ້າຈົນກວ່າການລົງບັນຊີລາຍຈ່າຍຈະເສັດສິ້ນຈຶ່ງສາມາດນຳເຂົ້າສິນຄ້າໃນສະກຸນເງິນກີບໄດ້');";
                        echo"window.location.href='import2.php';";
                        echo"</script>";
                    }
                    elseif(mysqli_num_rows($resultsa) > 0){
                        ...
                        $sqladd = "insert into listimp(billimp,billno,sup_id,emp_id,pro_id,serial,mac_address,qty,price,dateimp,timeimp,moreinfo,rate_id,rate,acc_id,po_id) values('$billimp','$billno','$sup_id','$emp_id','$pro_id','$serial','$mac_address','$qty','$price','$Date','$Time','$note','LAK','1','69100000','$newpo');";
        ...
        <div class="table-responsive">
            <table class="table table-striped" style="width: 1800px;" >
              <tr class="info">
                  ...
                  <th  style="width: 80px;">mac_address</th>
                  <th  style="width: 200px;">ຊື່ສິນຄ້າ</th>
                  <th  style="width: 50px;">ປະເພດ</th>
                  <th  style="width: 80px;">ຈຳນວນ</th>
                  <th  style="width: 60px;">ຫົວໜ່ວຍ</th>
                  <th  style="width: 120px;">ລາຄາ</th>
                  <th  style="width: 180px;">ລວມ</th>
                  <th  style="width: 80px;">ເລກທີບິນສັ່ງຊື້</th>
                  <th  style="width: 150px;">ເລກທີບິນນຳເຂົ້າ</th>
                  <th  style="width: 250px;">ຜູ້ສະໜອງ</th>
                  <th  style="width: 100px;">ໝາຍເຫດ</th>
                  <th></th>
              </tr>
              <?php 
                $sqlsec = "select l.No_,billimp,l.billno,company,emp_name,mac_address,l.pro_id,pro_name,unit_name,cate_name,serial,l.qty,l.price,l.qty*l.price as total,l.moreinfo from listimp l join products p on l.pro_id=p.pro_id join category c on p.cate_id=c.cate_id join unit u on p.unit_id=u.unit_id join supplier s on l.sup_id=s.sup_id join employees e on l.emp_id=e.emp_id where rate_id='LAK';";
              ...
              <tr>
                  ...
                  <td align="center">
                      <a href="Deleteimport.php?No_=<?php echo $row['No_'];?>">
              ...
              <?php 
                ...
                $sqlsum = "select sum(qty*price) as Total from listimp where rate_id='LAK';";
                ...
                <tr>
                    <td colspan="9" align="right" class="font26"><b>ລວມທັງໝົດ</b> </td>
                    <td colspan="5" align="center" class="font26"><b><?php echo number_format($total['Total']); ?> ກີບ</b> </td>
                </tr>
            </table>
        </div>
    ...
    <?php
        if(isset($_POST['btnSave'])){
            ...
            $po = mysqli_fetch_array($resultpo, MYSQLI_ASSOC);
            $newpo = $po['po_bill'] + 1;
            $sqlinsert = "insert into po(po_id,emp_id,kip_amount,po_date,po_time,status) values('$newpo','$emp_id','$sumimp','$Date','$Time','PAID');";
