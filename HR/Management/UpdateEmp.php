  ...
  <body >
    ...
    <?php
        if(isset($_POST['btnUpdate'])){
            ...
            {
                $sql = "update employees set emp_name='$emp_name', emp_surname='$emp_surname',gender='$gender',dob='$dob',address='$address',tel='$tel',email='$email',pass='$pass',auther_id='$auther',status='$status',salary='$salary',start_work='$start',end_work='$end' where emp_id ='$emp_id';";
