      ...
      <div class="container font16">
            <div class="row">
                <div class="col-xs-12 col-sm-6">
                    <b>ລາຍງານການວາງບິນ</b>&nbsp <img src="../../image/hidemenu.png" width="15px">
                </div>
            </div>
            <br>
      </div>
        ...
        <div class="table-responsive">
            <table class="table table-striped" style="width: 1300px;">
                <tr>
                    ...
                    <th style="width: 100px;">ວັນທີວາງບິນ</th>
                    <th style="width: 100px;">ວັນທີ່ຍັງເຫຼືອ</th>
                    <th style="width: 80px;">ໃບສັນຍາ</th>
                </tr>
                <?php
                    $sqlsearch = "select cus_id,company,address,tel,fax,email,end_promise,img_path,invoice_date,end_promise,datediff(invoice_date,'$Date') as day from customers where datediff(invoice_date,'$Date')<= 15;";
