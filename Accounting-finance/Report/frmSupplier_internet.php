...
<html>
  ...
  <body >
      ...
      <div class="container font16">
            <div class="row">
                <div class="col-xs-12 col-sm-6">
                    <b>ລາຍງານຜູ້ສະໜອງ ອິນເຕີເນັດ</b>&nbsp <img src="../../image/hidemenu.png" width="15px">
                </div>
            </div>
            <br>
      </div> 
    ...
    <div class="container font12b">
        <div>
            <form action="Report_supplier_internet.php" method="POST" id="form1">
        ...
        <div class="table-responsive">
            <table class="table table-striped" style="width: 1300px;">
                ...
                <?php
                    $sqlsearch = "select * from supplier where type='Internet';";
