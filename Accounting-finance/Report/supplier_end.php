...
<html>
  <head>
    ...
    <title>ລາຍງານຜູ້ສະໜອງໃກ້ຈະໝົດສັນຍາ</title>
      ...
      <div class="container font16">
            <div class="row">
                <div class="col-xs-12 col-sm-6">
                    <b>ລາຍງານຜູ້ສະໜອງໃກ້ຈະໝົດສັນຍາ</b>&nbsp <img src="../../image/hidemenu.png" width="15px">
                </div>
            </div>
            <br>
      </div>
    ...
    <div class="container font12b">
        <div class="table-responsive">
            <table class="table table-striped" style="width: 1300px;">
                ...
                <?php
                    $sqlsearch = "select sup_id,company,address,tel,fax,email,end_promise,img_path,end_promise,datediff(end_promise,'$Date') as day from supplier where datediff(end_promise,'$Date')<= 30 and type='Internet';";
