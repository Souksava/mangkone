        ...
        <div class="table-responsive">
            <table class="table table-striped" style="width: 1500px;">
                ...
                <tr class="font26">
                    ...
                    <th colspan="3" style="text-align: right;"><?php echo $rowsum['rate_id']; ?> <?php echo number_format(($rowsum['vat'] + $rowsum['amount_kip']),2); ?></th>
                </tr>
                <tr class="font26">
                ...
                <tr class="font26">
                    ...
                    <th colspan="3" style="text-align: right;"><?php echo $rowsum2['rate_id']; ?> <?php echo number_format(($rowsum2['vat'] + $rowsum2['amount_baht']),2); ?></th>
                </tr>
                <tr class="font26">
                ...
                <tr class="font26">
                    ...
                    <th colspan="3" style="text-align: right;"><?php echo $rowsum3['rate_id']; ?> <?php echo number_format(($rowsum3['vat'] + $rowsum3['amount_us']),2); ?></th>
                </tr>
                <?php
                    }
                    else {       
                ...
                <tr class="font26">
                    ...
                    <th colspan="6" style="text-align: right;"><?php echo $rowsum4['rate_id']; ?> <?php echo number_format($rowsum4['amount'],2); ?> </th>
                ...
                <tr class="font26">
                    ...
                    <th colspan="3" style="text-align: right;"><?php echo $rowsum4['rate_id']; ?> <?php echo number_format(($rowsum4['vat'] + $rowsum4['amount']),2); ?></th>
                </tr>
                <?php 
                    }
                ?>
