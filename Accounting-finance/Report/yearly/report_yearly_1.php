...
<html>
  ...
  <body >
    ...
    <div class="container font14">
        <form action="report_yearly_1.php" method="POST" id="form1">
            <div class="row">
    ...
    ?>
        ...
        <div class="row">
            ...
            <div align="right" class="col-xs-12 col-sm-6 col-md-4 form-group">
                <br><br><br>
                ສະກຸນເງິນກີບ
                <form action="Report_year.php" method="POST" id="form1">
        ...
        <div class="table-responsive">
            <table width="100%">
                 ...
                 <!-- <tr>
                    ...
                    <td align="right">
                        <?php                         
                            ...
                            $result = mysqli_query($link,$sql);
                            while($row = mysqli_fetch_array($result, MYSQLI_ASSOC)){ 
                                echo  " &nbsp;".number_format($row['po_price'])."&nbsp;<br>";
                            }
                        ?>
                    </td>
                    <td align="right">
                        <?php                         
                            ...
                            $result = mysqli_query($link,$sql);
                            while($row = mysqli_fetch_array($result, MYSQLI_ASSOC)){ 
                                echo  " &nbsp;".number_format($row['re_price'])."&nbsp;<br>";
                            }
                        ?>
                     </td>
                    <td align="right"> 
                        <?php                         
                            ...
                            $result = mysqli_query($link,$sql);
                            while($row = mysqli_fetch_array($result, MYSQLI_ASSOC)){ 
                                echo  " &nbsp;".number_format($row['po_total'])."&nbsp;<br>";
                            }
                        ?>
                    </td>
                    <td align="right"> 
                        <?php                         
                            ...
                            $result = mysqli_query($link,$sql);
                            while($row = mysqli_fetch_array($result, MYSQLI_ASSOC)){ 
                                echo  " &nbsp;".number_format($row['re_total'])."&nbsp;<br>";
                            }
                        ?>
                    </td>
                    <td align="right">
                    <?php                         
                            ...
                            while($row = mysqli_fetch_array($result, MYSQLI_ASSOC)){ 
                                ...
                                if($total_po > 0){
                                    echo number_format($total_po)."&nbsp;<br>";
                                }
                                else{
                                    echo"0&nbsp;<br>";
                                }
                    ...
                    <td align="right">
                        <?php                         
                            ...
                            while($row = mysqli_fetch_array($result, MYSQLI_ASSOC)){ 
                                ...
                                $this_year2 = $row['re_total'] - $row['po_total'];
                                $total_re = $last_year2 + $this_year2;
                                if($total_re > 0){
                                    echo number_format($total_re)."&nbsp;<br>";
                                }
                                else{
                                    echo"0&nbsp;<br>";
                                }
                ...
                <tr align="right">
                    ...
                    <td><?php echo number_format($rowsum['po_price']) ?>&nbsp;</td>
                    <td><?php echo number_format($rowsum['re_price']) ?>&nbsp;</td>
                    <td> <?php echo number_format($rowsum['po_total']) ?>&nbsp;</td>
                    <td> <?php echo number_format($rowsum['re_total']) ?>&nbsp;</td>
                    <td>
                        <?php 
                ...
                <tr>
                    ...
                    <td align="right"><?php echo number_format($row['po_price']) ?></td>
                    <td align="right"><?php echo number_format($row['re_price']) ?></td>
