...
<html>
  <head>
    ...
    <title>ໃບດຸນດ່ຽງ ພາຍຫຼັງ ການປັບປຸງ</title>
  ...
  <body >
      ...
      <div class="header">
        <div class="container font18">
            ...
            <div align="center" class="tapbar">
                <b>ໃບດຸນດ່ຽງ ພາຍຫຼັງ ການປັບປຸງ</b>
            </div>
    ...
    <div class="container font14">
        <form action="report_yearly_2.php" method="POST" id="form1">
            <div class="row">
    ...
    ?>
        ...
        <div class="row">
            ...
            <div align="center" class="col-xs-12 col-sm-6 col-md-4 form-group">
                <h3>ໃບດຸນດ່ຽງ ພາຍຫຼັງ ການປັບປຸງ</h3>
            ...
            <div align="right" class="col-xs-12 col-sm-6 col-md-4 form-group">
                <br><br><br>
                ສະກຸນເງິນກີບ
                <form action="Report_year2.php" method="POST" id="form1">
