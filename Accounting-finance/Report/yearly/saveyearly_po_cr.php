...
<html>
  <head>
    ...
    <title>ຍອດຍົກລາຍຮັບ-ລ່າຍຈ່າຍປີກ່ອນ</title>
  ...
  <body >
      ...
      <div class="header">
        <div class="container font18">
            ...
            <div align="center" class="tapbar">
                <b>ຍອດຍົກລາຍຮັບ-ລາຍຈ່າຍປີກ່ອນ</b>
            </div>
    ...
    <div class="container font16">
        <form action="saveyearly_po_cr.php" method="POST" id="form1" enctype="multipart/form-data">
            <div class="row ">
                <div class="col-xs-12 col-sm-6 form-group">
                    ...
                    <select name="acc_id" class="form-control" id="">
                        ...
                        <?php
                            $sqlacc_no = "select * from acc_no a left join acc_unit u on a.unit_id=u.unit_id left join acc_property p on u.ppy_id=p.ppy_id where ppy_name='ລາຍຈ່າຍ' or ppy_name='ລາຍຮັບ' order by acc_name asc;";
    ...
    <?php
        if(isset($_POST['btnadd'])){
            ...
            $sqlck = "select * from listyearly_po_cr where acc_id='$acc_id' and year(year_date)=date_format('$year_date','%Y');";
            ...
            elseif(mysqli_num_rows($resultck) > 0){
                ...
                $sql = "insert into listyearly_po_cr(po_price,re_price,acc_id,year_date) values('$po_price','$re_price','$acc_id','$year_date');";
    ...
    <div class="container font14">
        <hr width="90%" />
        <form action="saveyearly_po_cr.php" method="POST" id="formsave">
            <div class="table-responsive">
                <table class="table table-striped" style="width: 1200px;">
                    ...
                    <tr>
                    <?php
                        $sqlshow = "select id,y.acc_id,acc_name,year_date,po_price,re_price from listyearly_po_cr y left join acc_no a on y.acc_id=a.acc_id;";
                    ...
                    ?>
                        ...
                        <td>
                            <a href="del2.php?id=<?php echo $rowshow['id'];?>">
                    ...
                    <?php
                        ...
                        $sqlamount = "select sum(po_price) as po_amount,sum(re_price) as re_amount from listyearly_po_cr;";
    ...
    if(isset($_POST['btnSave'])){
        $sqlck2 = "select l.acc_id,acc_name,year(l.year_date) as year from listyearly_po_cr l left join yearly_po_cr y on l.year_date=y.year_date left join acc_no a on l.acc_id=a.acc_id where year(l.year_date) = year(y.year_date)";
        ...
        if(mysqli_num_rows($resultck2) > 0){
            ...
            $sqlsave = "insert into yearly_po_cr(po_price,re_price,acc_id,year_date) select po_price,re_price,acc_id,year_date from listyearly_po_cr;";
            ...
            if(!$resultsave){
                ...
                echo"window.location.href='saveyearly_po_cr.php';";
                echo"</script>";
                $sqlclear = "delete from listyearly_po_cr;";
