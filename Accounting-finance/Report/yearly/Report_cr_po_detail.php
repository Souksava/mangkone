...
function ShowData(){
    ...
    if(isset($_POST['btnall'])){
        ...
        $output .='
                    ...
                    <tr>
                        <td>ສ່ວນປ່ຽນແປງຂອງເຄື່ອງນສາງ(ຄ.ທ້າຍປີ-ຄ.ຕົ້ນປີ) + ຫຼື -</td>
                        <td align="right">0</td>
                        <td align="right">0</td>
                        <td><b></b></td>
                        <td><b></b></td>
                    ...
                    <tr>
                        <td>ລາຍຈ່າຍທີ່ຕ້ອງເປັນມູນຄ່າຄົງທີ</td>
                        <td align="right">0</td>
                        <td align="right">0</td>
                        <td><b></b></td>
                        <td><b></b></td>
                    ...
                    <tr>
                        <td>ຜະລິດຕະພັນເກັບມ້ຽນໃນສາງ(ຄ.ທ້າຍປີ-ຄ.ຕົ້ນປີ) + ຫຼື -</td>
                        <td align="right">0</td>
                        <td align="right">0</td>
                        <td><b></b></td>
                        <td><b></b></td>
                    ...
                    <tr>
                        <td>ຜົນຜະລິດຄົງທີ່ ແລະ ຊົມໃຊ້ເອງ</td>
                        <td align="right">0</td>
                        <td align="right">0</td>
                        <td><b></b></td>
                        <td><b></b></td>
...
$content = '
            ...
            <div style="float: left; width: 38%;text-align:center;font-size:12px;">
                <br><b style="font-size: 18px;">ໃບລາຍງານຜົນໄດ້ຮັບ</b>
            </div>
...
$mpdf->Output('ໃບລາຍງານຜົນໄດ້ຮັບ.pdf','I');
?>