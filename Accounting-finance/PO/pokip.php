...
<html>
  ...
  <body >
    ...
    <div class="container font16">
        <form action="pokip.php" method="POST" id="form1" enctype="multipart/form-data">
            <div class="row"  align="left">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 form-group">
                    ...
                    <input type="date" name="po_datea" class="form-control">
                </div>
                <div class="col-xs-12 col-sm-6 col-md-4 form-group" >
    ...
    <div class="container font14">
        <hr width="90%" />
        <form action="pokip.php" method="POST" id="formsave">
            <div class="row">
            ...
            <div class="table-responsive">
                <table class="table table-striped" style="width: 1500px;">
                    <tr class="warning">
                        <th colspan="14" style="text-align: center;font-size: 18px;"><b>ລາຍການບັນຊີລາຍຈ່າຍເງິນກີບ</b></th>
                    </tr>
                    <tr>
                        <th>#</th>
                        <th>ເລກທີບິນ</th>
                    ...
                    ?>
                        ...
                        <td align="right"><?php echo number_format($rowshow['total'],2); ?></td>
                        <td><?php echo $rowshow['note'] ?></td>
                        <td><?php echo number_format($rowshow['purchase_id']); ?></td>
                        <td>
                            <img src="../../Stock/Management/images/<?php echo $rowshow['img_path']; ?>" width="40px" height="40px" alt="" class="img-circle" />
                        </td>
                        <td><?php echo $rowshow['acc_name']; ?></td>
                        <td>
                            <a href="deletepokip.php?no_=<?php echo $rowshow['no_'];?>">
                    ...
                    <tr class="danger">
                        ...
                        <th colspan="5" style="text-align: center;font-size: 26px;"><b><?php echo number_format($rowamount['amount']); ?> ກີບ</b>
    ...
    <?php
        if(isset($_POST['btnSave'])){
            ...
            elseif(trim($po_date) == ""){
                ...
                $sqlsavepo = "insert into po(po_id,emp_id,kip_amount,po_date,po_time,status) values('$po_id2','$emp_id','$amount','$po_date','$Time','$status');";
