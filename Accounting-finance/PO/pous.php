...
<html>
  ...
  <body >
    ...
    <div class="container font16">
        <form action="pous.php" method="POST" id="form1" enctype="multipart/form-data">
    ...
    <?php
        if(isset($_POST['btnadd'])){
            ...
            if(trim($po_datea) == ""){
                ...
                echo"window.location.href='pous.php';";
                echo"</script>";
            }
            ...
            elseif(trim($acc_ida) == ""){
                ...
                echo"</script>";
                    ...
                    $sqlckpo = "select * from listpodetail where rate_id='LAK' or rate_id='THB';";
                    ...
                    elseif(mysqli_num_rows($resultpo) > 0){
                        echo"<script>";
                        echo"alert('ຂໍອະໄພ ເນື່ອງຈາກຕອນນີ້ມີຜູ້ໃຊ້ລະບົບກຳລັງທຳການລົງບັນຊີລາຍຈ່າຍເງິນບາດ ຫຼື ເງິນກີບຢູ່ໃນຕອນນີ້, ກະລຸນາລໍຖ້າຈົນກວ່າການລົງບັນຊີລາຍຈ່າຍເງິນບາດ ຫຼື ເງິນກີບຈະເສັດສິ້ນຈຶ່ງສາມາດລົງບັນລາຍຈ່າຍເງິນໂດລາໄດ້');";
                        echo"window.location.href='pous.php';";
                        echo"</script>";
                    }
                    elseif(mysqli_num_rows($resultsa) > 0){
                        echo"<script>";
                        echo"alert('ຂໍອະໄພ ເນື່ອງຈາກຕອນນີ້ມີຜູ້ໃຊ້ລະບົບກຳລັງລົງບັນຊີເບີກຈ່າຍເງິນເດືອນຢູ່ ກະລຸນາລໍຖ້າຈົນກວ່າການລົງບັນຊີເບີກຈ່າຍເງິນເດືອນຈະເສັດສິ້ນຈຶ່ງສາມາດລົງບັນລາຍຈ່າຍເງິນໂດລາໄດ້');";
    ...
    <div class="container font14">
        <hr width="90%" />
        <form action="pous.php" method="POST" id="formsave">
            <div class="row">
            ...
            <div class="table-responsive">
                <table class="table table-striped" style="width: 1500px;">
                    <tr class="warning">
                        <th colspan="14" style="text-align: center;font-size: 18px;"><b>ລາຍການບັນຊີລາຍຈ່າຍເງິນໂດລາ</b></th>
                    </tr>
                    <tr>
                        <th>#</th>
                        <th>ເລກທີບິນ</th>
                    ...
                    <tr>
                    <?php
                        $sqlshow = "select * from listpodetail_view where rate_id='USD';";
                    ...
                    ?>
                        ...
                        <td>
                            <img src="../../Stock/Management/images/<?php echo $rowshow['img_path']; ?>" alt="" width="40px" height="40px" class="img-circle" />
                        </td>
                        <td><?php echo $rowshow['acc_name']; ?></td>
                        <td>
                            <a href="deletepous.php?no_=<?php echo $rowshow['no_'];?>">
                    ...
                    <?php
                        ...
                        $sqlamount = "select sum(total) as amount from listpodetail_view where rate_id='USD';";
                    ...
                    <tr class="danger">
                        ...
                        <th colspan="5" style="text-align: center;font-size: 26px;"><b><?php echo number_format($rowamount['amount']); ?> ໂດລາ</b>
    ...
    <?php
        if(isset($_POST['btnSave'])){
            ...
            elseif(trim($po_date) == ""){
                ...
                $sqlsavepo = "insert into po(po_id,emp_id,us_amount,po_date,po_time,status) values('$po_id2','$emp_id','$amount','$po_date','$Time','$status');";
