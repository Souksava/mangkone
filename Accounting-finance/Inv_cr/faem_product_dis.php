        ...
        <div class="table-responsive">
            <table class="table table-striped" style="width: 1300px;">
                ...
                <tr>
                    ...
                    <form action="faem_product_dis.php" method="POST" id="uploadfile" enctype="multipart/form-data">
                        <td>
                    ...
                    <td>
                        <a href="productdetail_dis.php?voice_id=<?php echo $row['voice_id']; ?>">
    ...
    <?php
        if(isset($_POST['btnUpload'])){
            ...
            if($_FILES['img_path']['name'] == ""){
                ...
                echo"window.location.href='faem_product_dis.php';";
                echo"</script>";
            }
            else{
