...
<html>
  ...
  <body >
    ...
    <div class="container font16">
        <form action="invoice_pro_us.php" method="POST" id="form1" enctype="multipart/form-data">
            <div class="row ">
    ...
    <?php
        if(isset($_POST['btnadd'])){
            ...
            if(trim($pro_id) == ""){
                ...
                echo"window.location.href='invoice_pro_us.php';";
                echo"</script>";
            }
            elseif(trim($serial) == ""){
                echo"<script>";
            ...
            elseif(trim($qty) == ""){
              ...
              if(mysqli_num_rows($resultpro) == 0){
                ...
                echo"</script>";
                    ...
                    $sqlck2 = "select * from listinvoicedetail2 where rate_id='LAK' or rate_id='THB';";
               ...
               if(mysqli_num_rows($resultck2) > 0){
                    echo"<script>";
                    echo"alert('ກະລຸນາລໍຖ້າ ເນື່ອງຈາກໃນຂະນະນີ້ມີຜູ້ໃຊ້ລະບົບກຳລັງເຮັດໃບ invoice ໃນສະກຸນເງິນກີບ ຫຼື ບາດຢູ່');";
                    echo"window.location.href='invoice_pro_us.php';";
                    echo"</script>";
                }
                elseif(mysqli_num_rows($resultqty) > 0){
                        ...
                        $sqlprice = "select price_us from products where pro_id='$pro_id';";
                        ...
                        $vat = ($price * $qty) * 0.10;
                        $sqladd = "insert into listinvoicedetail2(pro_id,serial,mac_address,qty,price,vat,voice_id,rate_id,note,acc_id) values('$pro_id','$serial','$mac_address','$qty','$price','$vat','$voice_id','USD','$note','71410000');";
    ...
    <div class="container font14">
        <hr width="90%" />
        <form action="invoice_pro_us.php" method="POST" id="formsave">
            <div class="row">
            ...
            <div class="table-responsive">
                <table class="table table-striped">
                    ...
                    <tr>
                    <?php
                        $sqlshow = "select indet_id,l.pro_id,pro_name,mac_address,serial,qty,l.price,qty*l.price as total,note from listinvoicedetail2 l left join products p on l.pro_id=p.pro_id where rate_id='USD';";
                    ...
                    ?>
                        ...
                        <td>
                            <a href="delete_pro_us.php?indet_id=<?php echo $rowshow['indet_id'];?>">
                    ...
                    <?php
                        ...
                        $sqlamount = "select sum(qty*price) as amount from listinvoicedetail2 where rate_id='USD';";
                    ...
                    <tr class="danger">
                        ...
                        <th colspan="5" style="text-align: center;font-size: 18px;"><b><?php echo number_format($rowamount['amount'],2); ?> ໂດລາ</b>
                    ...
                    <tr class="danger">
                        ...
                        <th colspan="5" style="text-align: center;font-size: 18px;"><b><?php echo number_format($showvat,2); ?> ໂດລາ</b>
                    ...
                    <tr class="danger">
                        ...
                        <th colspan="5" style="text-align: right;font-size: 18px;"><b>Amount</b></th>
                        <th colspan="5" style="text-align: center;font-size: 18px;"><b><?php echo number_format($newamount,2); ?> ໂດລາ</b>
        ...
        if(isset($_POST['btnSave'])){
           ...
           elseif($amount == 0){
            ...
            echo"</script>";
                ...
                $sqlsave = "insert into invoice2(voice_id,emp_id,us_amount,in_date,in_time,cus_id,quo_id) values('$voice_id2','$emp_id','$amount','$Date','$Time','$cus_id','$quo_id');";
