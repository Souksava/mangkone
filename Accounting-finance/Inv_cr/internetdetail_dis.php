...
<html>
  ...
  <body >
    ...
    ?>
    <form action="Report_invoice_in_dis.php" method="POST" id="form1">
    ...
    <div class="container font14">
        <table class="table table-striped">
            ...
            <?php
               $sql = "select indet_id,i.pro_id,pro_name,i.qty,i.price,i.qty*i.price as total,i.note,rate_id from invoicedetail i left join acc_product p on i.pro_id=p.pro_id where voice_id='$voice_id';";
            ...
            <?php
               ...
               $sqlsum = "select sum((qty*price) + vat) as newamount,rate_id,sum(qty*price) as amount,sum(vat) as vat,kip_amount,baht_amount,us_amount from invoicedetail d left join invoice i on d.voice_id=i.voice_id where d.voice_id = '$voice_id' group by rate_id;";
