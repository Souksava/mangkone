...
<html>
  ...
  <body >
    ...
    <div class="container font16">
        <form action="invoice_in_baht.php" method="POST" id="form1" enctype="multipart/form-data">
            <div class="row ">
    ...
    <?php
        if(isset($_POST['btnadd'])){
            ...
            if(trim($pro_id) == ""){
                ...
                echo"window.location.href='invoice_in_baht.php';";
                echo"</script>";
            }
            elseif(trim($qty) == ""){
                echo"<script>";
                ...
                $sqlck = "select * from listinvoicedetail where rate_id ='LAK' or rate_id = 'USD';";
               ...
               elseif(mysqli_num_rows($resultqty) > 0){
                    ...
                    $sqlprice = "select price_baht from acc_product where pro_id='$pro_id';";
                    $resultprice = mysqli_query($link,$sqlprice);
                    $rowprice = mysqli_fetch_array($resultprice, MYSQLI_ASSOC);
                    $price = $rowprice['price_baht'];
                    $vat = ($price * $qty) * 0.10;
                    $sqladd = "insert into listinvoicedetail(pro_id,qty,price,vat,voice_id,rate_id,note,acc_id) values('$pro_id','$qty','$price','$vat','$voice_id','THB','$note','71410000');";
    ...
    <div class="container font14">
        <hr width="90%" />
        <form action="invoice_in_baht.php" method="POST" id="formsave">
            <div class="row">
            ...
            <div class="table-responsive">
                <table class="table table-striped">
                    ...
                    <tr>
                    <?php
                        $sqlshow = "select indet_id,pro_name,qty,l.price,qty*l.price as total,note from listinvoicedetail l left join acc_product p on l.pro_id=p.pro_id where rate_id='THB';";
                    ...
                    ?>
                        ...
                        <td>
                            <a href="delete_in_baht.php?indet_id=<?php echo $rowshow['indet_id'];?>">
                    ...
                    <?php
                        ...
                        $sqlamount = "select sum(qty*price) as amount from listinvoicedetail where rate_id='THB';";
        ...
        if(isset($_POST['btnSave'])){
           ...
           elseif($amount == 0){
            ...
            echo"</script>";
                ...
                $sqlsave = "insert into invoice(voice_id,emp_id,baht_amount,in_date,in_time,cus_id,quo_id) values('$voice_id2','$emp_id','$amount','$Date','$Time','$cus_id','$quo_id');";
