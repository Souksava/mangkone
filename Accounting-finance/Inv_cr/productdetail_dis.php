...
<html>
  ...
  <body >
    ...
    ?>
    <form action="Report_invoice_pro_dis.php" method="POST" id="form1">
    ...
    <div class="container font14">
        <table class="table table-striped">
            ...
            <?php
               ...
               $sqlsum = "select sum((qty*price) + vat) as newamount,rate_id,sum(qty*price) as amount,sum(vat) as vat,kip_amount,us_amount,baht_amount from invoicedetail2 d left join invoice2 i on d.voice_id=i.voice_id where d.voice_id = '$voice_id' group by rate_id;";
