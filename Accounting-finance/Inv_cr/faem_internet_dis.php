...
<html>
  <head>
    ...
    <title>ແຟ້ມວາງບິນອິນເຕີເນັດ</title>
    ...
    <div class="container font16">
        <div class="row">
            <div class="col-xs-12 col-sm-6">
                <b>ແຟ້ມວາງບິນອິນເຕີເນັດ</b>&nbsp <img src="../../image/hidemenu.png" width="15px">
            </div>
    ...
    <div class="container font12b">
        <div class="table-responsive">
            <table class="table table-striped">
                ...
                <?php
                    $search = "%".$_POST['search']."%";
                    $sqlsearch = "select voice_id,emp_name,kip_amount,baht_amount,us_amount,in_date,in_time,company,i.img_path from invoice i left join employees e on i.emp_id=e.emp_id left join customers c on i.cus_id=c.cus_id where i.voice_id like '$search' or e.emp_name like '$search' or company like '$search' or in_date like '$search';";
                ...
                <tr>
                    ...
                    <form action="faem_internet_dis.php" method="POST" id="uploadfile" enctype="multipart/form-data">
                        <td>
                    ...
                    <td>
                        <a href="internetdetail_dis.php?voice_id=<?php echo $row['voice_id']; ?>">
                ...
                <?php
                    ...
                    $sqlsum = "select count(voice_id) as qty,sum(kip_amount) as totalkip,sum(baht_amount) as totalbaht,sum(us_amount) as totalus from invoice;";
    ...
    <?php
        if(isset($_POST['btnUpload'])){
            ...
            if($_FILES['img_path']['name'] == ""){
                ...
                echo"window.location.href='faem_internet_dis.php';";
                echo"</script>";
            }
            else{
                ...
                $sqlupload = "update invoice set img_path='$pro_img' where voice_id='$voice_id';";
