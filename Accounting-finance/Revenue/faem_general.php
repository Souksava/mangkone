    ...
    <div class="container font16">
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-6 form-group" align="right">
                <form action="faem_general.php" method="POST" id="fomrsearch">
        ...
        <div class="table-responsive">
            <table class="table table-striped" style="width: 1300px;">
                ...
                <tr>
                    ...
                    <form action="faem_general.php" method="POST" id="uploadfile" enctype="multipart/form-data">
                        <td>
                    ...
                    <td>
                        <a href="faemdetail_general.php?re_id=<?php echo $row['re_id']; ?>">
    ...
    <?php
        if(isset($_POST['btnUpload'])){
            ...
            if($_FILES['img_path']['name'] == ""){
                ...
                echo"window.location.href='faem_general.php';";
                echo"</script>";
            }
            else{
