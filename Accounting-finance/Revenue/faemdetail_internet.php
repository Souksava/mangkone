    ...
    <form action="Report_internet.php" method="POST" id="form1">
        <div class="container font14">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 form-group">
                    <input type="text" name="textbill" placeholder="ຊື່ຫຍໍ້ລູກຄ້າ" class="form-control">
                </div>
            </div>
            <div class="row">
