...
<html>
  ...
  <body >
    ...
    <div class="container font16">
        <form action="revenue_kip.php" method="POST" id="form1" enctype="multipart/form-data">
    ...
    <div class="container font14">
        <hr width="90%" />
        <form action="revenue_kip.php" method="POST" id="formsave">
            <div class="row">
            ...
            <div class="table-responsive">
                <table class="table table-striped" style="width: 1500px;">
                    ...
                    <tr>
                    <?php
                        $sqlshow = "select cash_id,re_id,cash_name,qty,price,qty*price as total,vat,cash_date,note,bill,acc_name,l.acc_id,rate_id,rate,img_path from listcash_receipt l left join acc_no a on l.acc_id=a.acc_id where rate_id='LAK';";
                    ...
                    ?>
                        ...
                        <td>
                            <a href="del_revenue_kip.php?cash_id=<?php echo $rowshow['cash_id'];?>">
                    ...
                    <tr class="danger">
                        ...
                        <th colspan="5" style="text-align: center;font-size: 26px;"><b><?php echo number_format($rowamount['amount'],2); ?> ກີບ</b>
    ...
    <?php
        if(isset($_POST['btnSave'])){
            ...
            elseif(trim($re_date) == ""){
                ...
                $sqlsavepo = "insert into receipt(re_id,emp_id,cus_id,re_date,kip_amount,bill) values('$cash_id','$emp_id','$cus_id','$re_date','$amount','$bill_');";
