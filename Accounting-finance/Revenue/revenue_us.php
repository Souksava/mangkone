...
<html>
  ...
  <body >
    ...
    <div class="container font16">
        <form action="revenue_us.php" method="POST" id="form1" enctype="multipart/form-data">
        ...
        if(isset($_POST['btnadd'])){
            ...
            elseif($cash_date == ""){
                ...
                echo"</script>";
                    ...
                    $sqlckpo = "select * from listcash_receipt where rate_id='LAK' or rate_id='THB';";
        ...
        <form action="revenue_us.php" method="POST" id="formsave">
            ...
            <div class="table-responsive">
                <table class="table table-striped" style="width: 1500px;">
                    ...
                    <tr>
                    <?php
                        $sqlshow = "select cash_id,re_id,cash_name,qty,price,qty*price as total,vat,cash_date,note,bill,acc_name,l.acc_id,rate_id,rate,img_path from listcash_receipt l left join acc_no a on l.acc_id=a.acc_id where rate_id='USD';";
                    ...
                    ?>
                        ...
                        <td>
                            <a href="del_revenue_us.php?cash_id=<?php echo $rowshow['cash_id'];?>">
                    ...
                    <?php
                        ...
                        $sqlamount = "select sum(qty*price) as amount from listcash_receipt where rate_id='USD';";
                    ...
                    <tr class="danger">
                        ...
                        <th colspan="5" style="text-align: center;font-size: 26px;"><b><?php echo number_format($rowamount['amount'],2); ?> ໂດລາ</b>
    ...
    <?php
        if(isset($_POST['btnSave'])){
            ...
            elseif(trim($re_date) == ""){
                ...
                $sqlsavepo = "insert into receipt(re_id,emp_id,cus_id,re_date,us_amount,bill) values('$cash_id','$emp_id','$cus_id','$re_date','$amount','$bill_');";
