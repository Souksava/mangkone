      ...
      <div class="container font16">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6" align="right">
                    ...
                    <form action="Supplier.php" method="POST" id="form1" enctype="multipart/form-data">
                    ...
                    <?php
                        if(isset($_POST['btnsave'])){
                            ...
                            elseif(trim($type) == ""){
                                ...
                                $sql = "insert into supplier(company,tel,fax,address,email,type,end_promise,img_path) values('$company','$tel','$fax','$address','$email','$type','$end_promise','$pro_img');";
      ...
      <div class="container">
            <div class="row">
                <form action="Supplier.php" method="POST" id="fomrsearch">
                    <input type="text" class="form-control" name="search" style="width: 300px;" placeholder="ຄົ້ນຫາ ລະຫັດ, ຊື່ບໍລິສັດ">
        ...
        <div class="table-responsive">
            <table class="table table-striped" style="width: 2000px;">
                <tr>
                    ...
                    <th style="width: 100px;">ສັນຍາຫຼັກຖານ</th>
                    <th style="width: 100px;">ປະເພດຜູ້ສະໜອງ</th>
                ...
                <tr>
                    ...
                    <td>
                        <a href="../../Stock/Management/images/<?php echo $row['img_path']; ?>" alt="">
